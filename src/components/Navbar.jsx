      ...
      >
        <div className="mt-2 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl shadow-slate-200/70">
          ...
          <div className="flex flex-col gap-2 border-t border-slate-100 p-4">
            <a
              className="inline-flex w-full items-center justify-center rounded-xl bg-[#25D366] px-4 py-2 text-sm font-semibold text-white shadow-md shadow-[#25D366]/30 transition hover:bg-[#22c05d]"
              href={whatsappHref}
              target="_blank"
              rel="noopener noreferrer"
            >
